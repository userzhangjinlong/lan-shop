...
Route::group([
    ...
    $router->get('advimages/{id}/edit','AdvImageController@edit');
    $router->put('advimages/{id}', 'AdvImageController@update');
    $router->delete('advimages/{adv_id}/{id}', 'AdvImageController@destory');
